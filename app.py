...
# ── JUNA-ASEMIEN TÄYDET NIMET DYNAMIIKKA + VARASANAKIRJA ──────────────────────

@st.cache_data(ttl=86400)
def hae_juna_asemat():
    # Vankka varasanakirja yleisimmille lähtöasemille (estää lyhenteiden näkymisen)
    asemat = {
    ...
    try:
        ...
        for s in resp.json():
            # Ylikirjoitetaan ja täydennetään API-datalla, poistetaan " asema" teksti
...
def get_trains(asema_nimi):
    ...
    try:
        ...
        for juna in data:
            ...
            # Käännetään koodi kokonaiseksi kaupungin nimeksi
        ...
        return [{"train": "API-virhe", "origin": str(e)[:40], "time": "-", "dt": None, "delay": 0}]
...
# HSL:n pitkä hakulinkki tallennetaan muuttujaan luettavuuden vuoksi
...
tab1, tab2, tab3, tab4, tab5 = st.tabs([
    "Kulttuuri & VIP", "Urheilu", "Messut & Arenat", "Musiikki", "🔴 Live (Kaupunki API)"
])

# Päivitetty tuki toiselle linkille (esim. HJK ja Veikkaus Arena samassa)
def venue_card(p):
    card = (
    ...
    if 'linkki2' in p:
        card += f" &nbsp;&nbsp;|&nbsp;&nbsp; <a href='{p['linkki2']}' class='taksi-link' target='_blank' style='font-size:16px;'>{p['teksti2']} →</a>"
    card += f"</div>"
    return card
    ...
    paikat = [
        {
            ...
            "kap": "947 hlö",
            "huomio": "Paras yksittäinen kohde. Eläintarha.",
        ...
        },
        {
            ...
            "kap": "1 700 hlö",
            "huomio": "Ooppera = parhaat kyydit. Töölönlahti.",
            "lopetus": "klo 21:00–23:00 (ooppera pidempi)",
            "linkki": "https://oopperabaletti.fi/kalenteri/",
        ...
        },
        {
            ...
            "kap": "1 000 hlö",
            "huomio": "Aseman vieressä, Rautatientori.",
            "lopetus": "klo 21:00–22:30",
            "linkki": "https://www.kansallisteatteri.fi/ohjelmisto/ohjelmistokalenteri",
        ...
        {
            "nimi": "Tanssin talo (Kaapelitehdas)",
            "kap": "1 000 hlö",
            "huomio": "Modernin tanssin keskus. Erkko-sali 700 hlö, Pannuhalli 235 hlö.",
            "lopetus": "klo 21:00–22:30",
            "linkki": "https://www.tanssintalo.fi/ohjelma",
            "teksti": "Tanssin talo Kalenteri",
            "badge": "badge-blue",
        },
        {
            "nimi": "Helsingin Suomalainen Klubi",
            "kap": "300 hlö",
            "huomio": "Yritysjohto – pitkät iltakyydit arki-iltaisin. Kamppi.",
        ...
        },
        {
            ...
            "kap": "200 hlö",
            "huomio": "Korkeaprofiilinen – erityisseuranta tapahtumailtaisin. Kruununhaka.",
            "lopetus": "klo 22:00–01:00",
        ...
        },
        {
            ...
            "linkki": "https://finlandiatalo.fi/finlandia-talo/tulevat-tapahtumat/",
            "teksti": "Finlandia-talo Kalenteri",
            "badge": "badge-yellow",
        },
        {
            "nimi": "Kaapelitehdas (Yleinen)",
            "kap": "3 200 hlö",
            "huomio": "Kulttuuritapahtumat ja messut. Suurimmat tapahtumat Merikaapelihallissa.",
...
with tab2:
    paikat = [
        ...
        },
        {
            ...
            "kap": "8 200 hlö",
            "huomio": "Tarkista pelipaikka – vaihtelee kaudesta riippuen (Nordis vs. Kerava).",
            "lopetus": "klo 21:30–23:00",
        ...
        },
        {
            ...
            "kap": "50 000 hlö",
            "huomio": "Maaottelut, konsertit. Suuri poistumapiikki.",
        ...
        {
            "nimi": "Veikkaus Arena (ent. Bolt Arena)",
            "kap": "10 770 hlö",
            "huomio": "Veikkausliiga / HJK kotiottelut ja tapahtumat. Huono sää nostaa kyytikerrointa.",
            "lopetus": "klo 21:00–22:30 (45+45+lisäaika)",
            "linkki": "https://www.veikkausarena.fi/fi/all-events",
            "teksti": "Veikkaus Arena Tapahtumat",
            "linkki2": "https://www.hjk.fi/ottelut/miehet/",
            "teksti2": "HJK Otteluohjelma",
            "badge": "badge-blue",
        },
    ]
    st.markdown(f"<div class='taksi-card'>{venue_html(paikat)}</div>", unsafe_allow_html=True)
...
with tab3:
    paikat = [
        ...
        {
            "nimi": "Hartwall Arena / Helsinki Halli",
            "kap": "15 000 hlö",
            "huomio": "Suuri poistumapiikki.",
            "lopetus": "klo 22:30–00:30 (konsertit)",
            "linkki": "https://www.hartwall-arena.fi/tapahtumat/",
            "teksti": "Arena Tapahtumat",
            "badge": "badge-red",
        },
        {
        ...
        {
            "nimi": "Helsingin alueen yleiskalenterit",
            "kap": "Koko kaupunki",
            "huomio": "Paras yleissilmäys kaikista kaupungin tapahtumista.",
            "lopetus": "Vaihtelee",
            "linkki": "https://stadissa.fi/",
            "teksti": "Stadissa.fi",
            "linkki2": "https://www.myhelsinki.fi/fi/tapahtumat",
            "teksti2": "MyHelsinki Tapahtumat",
            "badge": "badge-blue",
        },
    ]
    st.markdown(f"<div class='taksi-card'>{venue_html(paikat)}</div>", unsafe_allow_html=True)
    ...
    paikat = [
        {
            "nimi": "Tavastia",
            "kap": "900 hlö",
            "huomio": "Paras keikkapaikka kyytien kannalta.",
        ...
        },
        {
            ...
            "lopetus": "klo 22:00–01:00",
            "linkki": "https://www.rocks.fi/tapahtumat/",
        ...
        },
        {
            ...
            "linkki": "https://www.espoo.fi/fi/sellosalin-tapahtumat",
            "teksti": "Sellosali Ohjelma",
            "badge": "badge-blue",
        },
        {
            "nimi": "Flow Festival / Suvilahdentie",
            "kap": "30 000 hlö / päivä",
...
with tab5:
    live_tapahtumat = get_live_events()
    st.markdown("<div class='card-title'>Helsingin API: Päättyy tänä iltana</div>", unsafe_allow_html=True)
    
    if live_tapahtumat:
        live_html = ""
        for t in live_tapahtumat:
            live_html += (
                f"<div class='eventline'>"
                f"<span class='badge-blue'>LIVE</span> "
                f"<span class='venue-name'>{t['nimi']}</span><br>"
                f"<span class='venue-address'>📍 {t['paikka']}</span><br>"
                f"<span class='endtime'>⏱ Päättyy: klo {t['loppu']}</span>"
                f"</div>"
            )
        st.markdown(f"<div class='taksi-card'>{live_html}</div>", unsafe_allow_html=True)
    else:
        st.markdown(
            "<div class='taksi-card'>Ei tiedossa olevia suuria avoimia yleisötapahtumia tälle illalle "
            "(Lähde: Helsingin Kaupunki LinkedEvents).</div>", 
            unsafe_allow_html=True
        )
