...
# PÄIVITETTY: 5 minuutin päivitysväli (300 000 ms)
components.html("""
<script>
...
with tab2:
    paikat = [
        ...
        {
            "nimi": "Veikkaus Arena (Jokerit & Tapahtumat)",
            "kap": "15 000 hlö",
            "huomio": "Jokereiden kotiottelut ja suurtapahtumat. Valtava poistumapiikki.",
            "lopetus": "klo 21:00–22:30 (jääkiekko), 23:00 (konsertit)",
        ...
        },
        {
            "nimi": "Bolt Arena (HJK)",
            "kap": "10 770 hlö",
            "huomio": "Veikkausliiga ja HJK kotiottelut. Töölö. Huono sää nostaa kyytikerrointa.",
            "lopetus": "klo 21:00–22:30 (45+45+lisäaika)",
            "linkki": "https://www.hjk.fi/ottelut/miehet/",
            "teksti": "HJK Otteluohjelma",
            "badge": "badge-blue",
        },
        {
...
st.markdown(
    ...
    "TH Taktinen Tutka – Päivittyy 5 min välein – Digitraffic · Port of Helsinki · Averio · Finavia API"
    "</div>",
    unsafe_allow_html=True,
)
