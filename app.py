...
# ── FINAVIA API ──────────────────────────────────────────────────────────────
# Uusi virallinen avain (rekisteröity apiportal.finavia.fi)
FINAVIA_API_KEY = "5988d0319cd74d568ebd102bc091a6b4"
...
st.markdown("<div style='color:#555;font-size:14px;text-align:center;margin-top:20px;'>TH Taktinen Tutka - Päivittyy 60 s välein - Digitraffic - Port of Helsinki - Averio - Finavia API</div>", unsafe_allow_html=True)
